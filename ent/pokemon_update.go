...
func (pu *PokemonUpdate) Save(ctx context.Context) (int, error) {
	return withHooks[int, PokemonMutation](ctx, pu.sqlSave, pu.mutation, pu.hooks)
}
...
func (pu *PokemonUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := pu.mutation.AddedWeight(); ok {
		_spec.AddField(pokemon.FieldWeight, field.TypeFloat64, value)
	}
	...
	if value, ok := pu.mutation.AddedHeight(); ok {
		_spec.AddField(pokemon.FieldHeight, field.TypeFloat64, value)
	}
...
// Where appends a list predicates to the PokemonUpdate builder.
func (puo *PokemonUpdateOne) Where(ps ...predicate.Pokemon) *PokemonUpdateOne {
...
func (puo *PokemonUpdateOne) Save(ctx context.Context) (*Pokemon, error) {
	return withHooks[*Pokemon, PokemonMutation](ctx, puo.sqlSave, puo.mutation, puo.hooks)
}

...
func (bc *BattleCreate) Save(ctx context.Context) (*Battle, error) {
	bc.defaults()
	return withHooks[*Battle, BattleMutation](ctx, bc.sqlSave, bc.mutation, bc.hooks)
}
...
func (bc *BattleCreate) createSpec() (*Battle, *sqlgraph.CreateSpec) {
	var (
		...
		_spec = sqlgraph.NewCreateSpec(battle.Table, sqlgraph.NewFieldSpec(battle.FieldID, field.TypeInt))
	)
	...
	if value, ok := bc.mutation.CreatedAt(); ok {
		_spec.SetField(battle.FieldCreatedAt, field.TypeTime, value)
